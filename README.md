...
I'm a computer science student with a background in computer & network engineering. i build with modern web stacks, blockchain tech, and cloud infrastructure.
_<sup>Based in Indonesia 🇮🇩_</sup>

Currently exploring kubernetes and microservices.

alibaba cloud certified | always learning | coffee enthusiast ☕
